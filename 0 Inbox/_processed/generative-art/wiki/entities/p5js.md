...
- [[0 Inbox/_processed/generative-art/wiki/concepts/generative-art-artifact]] — p5.js 是制品的核心引擎
- [[0 Inbox/_processed/generative-art/wiki/concepts/seeded-randomness]] — `randomSeed()` / `noiseSeed()` 的底层实现
- [[0 Inbox/_processed/generative-art/wiki/concepts/algorithmic-philosophy]] — p5.js 是将哲学转化为代码的媒介
