...
| 日期 | 笔记 | 类型 |
|-----|------|------|
| 2026-01-25 | [[新闻/20260125-Apple选择Google而非OpenAI分析]] | 新闻分析 |
| 2026-01-25 | [[工作流/Obsidian阅读、分析、拆解-AI]] | 工作流 |
...
| 标签          | 说明     | 数量                                                             |
| ----------- | ------ | -------------------------------------------------------------- |
| #AI         | 通用AI标签 | `= length(filter(rows, r => r.tags && r.tags.includes("AI")))` |
| #LLM        | 大语言模型  |                                                                |
| #enterprise | 企业AI   |                                                                |
| #news       | AI新闻   |                                                                |
| #research   | 研究论文   |                                                                |
...
- [[工作流/Obsidian阅读、分析、拆解-AI]] - AI内容处理标准流程
- [[渐进式总结工作流]] - 通用阅读内化流程
- [[收件箱处理流程]] - 内容捕获入口
