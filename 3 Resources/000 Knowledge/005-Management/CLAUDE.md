...
**映射規則**:
1. 概念 frontmatter 使用 `ddc: "005"` + `udc: "659.2"`
...
*分類: 3 Resources/000 Knowledge/005-Management · DDC: 005 · UDC: 659.2 · Schema v1.1*
