...
| source | [[3 Resources/000 Knowledge/005-Knowledge-Management/wiki/sources/为什么你的大脑越来越乱\|為什麼你的大腦越來越亂]] | 來源追溯 |
| source | [[你学的所有笔记方法论\|你學的所有筆記方法論]] | 來源追溯 |
| source | [[六边形AI数字大脑模板\|六邊形 AI 數字大腦模板]] | 來源追溯 |

**修復**:
- [[3 Resources/000 Knowledge/005-Knowledge-Management/wiki/entities/Andrej-Karpathy\|Andrej Karpathy]] — topic: people → knowledge-management；修復 4 處斷鏈
...
**操作**: 修復 060-Knowledge-Management 子庫的基礎設施問題。

**變更**:
- CLAUDE.md: People Wiki Schema → KM Wiki Schema（DDC 060 知識管理）
