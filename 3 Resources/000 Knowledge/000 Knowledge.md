...
| 我想...              | 去这里                                                                         |
| ------------------ | --------------------------------------------------------------------------- |
| 📖 **系统学习 KOS 理论** | [[ram/Knowledge-Systems/Knowledge-Systems\|Knowledge-Systems 主入口]] → 三周学习路径 |
| 📚 **查阅原始资料**      | [[ram/Knowledge-Systems/README\|知识系统 (Knowledge Systems)]] → 九章节选读          |
...
| 🗺️ **看知识全景**      | [[ram/Knowledge-Systems/00-MOCs/知识系统 知识库总览\|MOC 总览]]                        |
...
| 层次 | 章节 | 核心 |
|:----:|------|------|
| 🌐 | [[ram/Knowledge-Systems/01-概述/01-概述\|01-概述]] | KOS 谱系、DIKW 金字塔 |
| 📜 | [[ram/Knowledge-Systems/02-分类法/02-分类法\|02-分类法]] | DDC、UDC、CLC |
| 📜 | [[ram/Knowledge-Systems/03-叙词表/03-叙词表\|03-叙词表]] | MeSH、LCSH |
| 📜 | [[ram/Knowledge-Systems/04-本体论/04-本体论\|04-本体论]] | OWL、RDF、SKOS |
| 🕸️ | [[ram/Knowledge-Systems/05-知识图谱/05-知识图谱\|05-知识图谱]] | Wikidata、企业 KG |
| 🕸️ | [[ram/Knowledge-Systems/06-关联数据/06-关联数据\|06-关联数据]] | Linked Data、SPARQL |
| 🏢 | [[ram/Knowledge-Systems/07-知识管理/07-知识管理\|07-知识管理]] | SECI、实践社区 |
| 🤖 | [[ram/Knowledge-Systems/08-AI与知识系统/08-AI与知识系统\|08-AI与知识系统]] | LLM + KG = RAG |
| 👤 | [[ram/Knowledge-Systems/09-个人知识管理/09-个人知识管理\|09-个人知识管理]] | Zettelkasten、Obsidian、PARA |

### 导航辅助

- [[ram/Knowledge-Systems/00-MOCs/知识系统 知识库总览\|知识库总览 MOC]]
- [[ram/Knowledge-Systems/00-MOCs/知识系统 学习路径\|三周学习路径]]
- [[ram/Knowledge-Systems/99-资源收集/知识系统 资源收集\|外部资源收集]]

### 分类系统详解

| 系统 | 入口 | 内容 |
|:----:|------|------|
| 📗 | [[ram/DDC/README\|DDC 知识库]] | Dewey十进分类法 — 9章深度详解 + 学习路径 |
| 📘 | [[ram/UDC/README\|UDC 知识库]] | 国际十进分类法 — 9章深度详解 + 学习路径 |
| 📊 | [[ram/DDC-UDC对比表\|DDC vs UDC 对比表]] | 全面横向对比：结构、符号、哲学、实践 |
