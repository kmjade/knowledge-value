...
# Obsidian Flashcards 插件

## 定義

Flashcards 是 Obsidian 中的閃念學習插件，支持間隔重複學習算法（SRS），可在 Obsidian 中創建和複習學習卡片。
...
Q: Obsidian 的核心文件格式是什麼？
翻譯：What is the core file format of Obsidian?
答案：Markdown

Q: Markdown 是什麼軟體的核心文件格式？
答案：Obsidian
```
...
Obsidian 是一款使用 {{Markdown}} 文件的強大知識管理軟體。
```
...
- [Flashcards 插件文檔](https://github.com/st3v3nmw/obsidian-spaced-repetition)
