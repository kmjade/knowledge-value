...
PARA 方法論是一種組織信息的系統方法，通過 Projects（項目）、Areas（領域）、Resources（資源）、Archives（歸檔）四個類別來管理所有信息。

## 分類對應

| PARA 類別 | Obsidian 文件夾 | 用途 | 時間跨度 |
|-----------|----------------|------|---------|
...
- [PARA 方法論官方文檔](https://buildingasecondbrain.com/basics/)
