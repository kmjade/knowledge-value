...
搜索優化是通過合理的命名、結構和標籤系統，提高知識庫中信息的可發現性和檢索效率。
...
### 高級搜索
- `keyword1 keyword2`: AND 搜索
- `keyword1 OR keyword2`: OR 搜索
- `keyword -exclude`: 排除詞
- `keyword*`: 通配符搜索
- `/regex/`: 正則表達式搜索
...
### 推薦插件
- [[Obsidian Dataview 插件]] - 強大的查詢和數據可視化
- **Tag Wrangler** - 標籤管理工具
...
- [Obsidian 搜索文檔](https://help.obsidian.md/Searching)
