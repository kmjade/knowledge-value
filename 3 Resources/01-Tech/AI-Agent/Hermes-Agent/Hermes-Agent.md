...
| 文档                  | 说明                         |
| ------------------- | -------------------------- |
| [[02-核心概念/Agent概述]] | 智能体架构和 Agent 循环            |
| [[02-核心概念/工具系统]]    | Toolsets 工具集详解             |
| [[02-核心概念/协议规范]]    | OpenAI 兼容 function calling |
| [[02-核心概念/工作流]]     | 单/多智能体工作流                  |

### 三、提供商会话

| 文档                      | 说明                          |
| ----------------------- | --------------------------- |
| [[03-模型系列/Hermes-3概览]]  | Nous Research 的 LLM 模型系列（附） |
| [[03-模型系列/Hermes-3-8B]] | 轻量级本地模型                     |
| [[Hermes-3-70B]]        |                             |
| [[Hermes-3-405B]]       |                             |
| [[05-API参考/Agent-API]]  | 配置项详解                       |

### 四、工具调用

| 文档                      | 说明                  |
| ----------------------- | ------------------- |
| [[04-工具调用/工具调用格式]]      | function calling 详解 |
| [[04-工具调用/JSON-Schema]] | 参数定义规范              |
| [[04-工具调用/工具执行模式]]      | 同步/异步/链式            |
| [[04-工具调用/错误处理]]        | 重试和回退               |
...
| 文档                       | 说明  |
| ------------------------ | --- |
| [[06-集成指南/LangChain集成]]  | 待更新 |
| [[06-集成指南/AutoGen集成]]    | 待更新 |
| [[06-集成指南/LlamaIndex集成]] | 待更新 |
| [[06-集成指南/MCP协议集成]]      | 待更新 |
...
| 文档                        | 说明                 |
| ------------------------- | ------------------ |
| [[09-问题解决/Windows-WSL问题]] | Windows 和 WSL 相关问题 |
