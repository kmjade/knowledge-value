...
aliases: [Python流程控制, Python函数编程]
created: 2026-02-01
---

# 控制流与函数

> 🎯 **学习目标**：掌握Python的程序控制逻辑和函数定义，能够编写结构化、可维护的代码。
...
for i in range(5):
    if i % 2 == 0:
        continue
    print(f"奇数: {i}")  # 只输出 1, 3

# else子句 - 循环正常完成后执行
for i in range(3):
    print(i)
else:
    print("循环正常完成")  # 循环结束后执行
...
for score in scores:
    ...
    print(f"分数: {score}, 等级: {grade}, 评价: {description}")
```
...
def check_password_strength(password):
    ...
    if len(password) >= 8:
        strength += 1
        feedback.append("密码长度符合要求")
    else:
        feedback.append("建议密码至少8位")
